...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-[var(--bg-secondary)] overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <div className="glass p-8 md:p-12 rounded-[40px] border border-[var(--border)] relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full px-6 py-4 rounded-2xl bg-[var(--bg-primary)] border border-[var(--border)] focus:border-primary outline-none transition-all ${errors.name ? 'border-red-500' : ''}`}
                      placeholder="Iqbal"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full px-6 py-4 rounded-2xl bg-[var(--bg-primary)] border border-[var(--border)] focus:border-primary outline-none transition-all ${errors.email ? 'border-red-500' : ''}`}
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className={`w-full px-6 py-4 rounded-2xl bg-[var(--bg-primary)] border border-[var(--border)] focus:border-primary outline-none transition-all resize-none ${errors.message ? 'border-red-500' : ''}`}
